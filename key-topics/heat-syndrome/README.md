...
This contains data on heat syndrome emergency department visits, and max daily temperature. Data in this repository feed the interface at [real-time heat-related illness](https://a816-dohbesp.nyc.gov/IndicatorPublic/key-topics/climatehealth/syndromic/)

## Data files

- `edheatYYYY_live.csv` — one file per year (currently 2021–2026), updated daily via `export-scripts/syndromic_push.r`
- `previous_years.csv` — historical data prior to the per-year live files
- `edheat1720_supp.csv` — supplemental data covering 2017–2020
